<%@ Page Title="" Language="C#" MasterPageFile="~/adminMasterPage.master" AutoEventWireup="true" CodeFile="a_manage_customers.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
      <div class="couple-profile-tabs general-nav-tabs tabs">
        ...
        <a href="#"class="active btn btn-default"><span class="badge">Manage Customer</span></a>
      ...
      <%--  <a href="#" class="btn btn-default"><span class="badge">Real Wedding</span></a>--%>
        ...
        <h4 class="refine-search-heading">Search Customer</h4>
          ...
          <div class="form-group"> 
            ...
            <div class="row">
              ...
              <div class="col-md-9 col-sm-6">
               <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter Registed Customer Email" class="form-control"></asp:TextBox>
              </div>
        ...
        <table>
          ...
          <ItemTemplate> 
              <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                 <ContentTemplate>
          <tr>
            <td class="vendor-img"><img src="<%# DataBinder.Eval(Container,"DataItem.profile") %>" class="img-responsive" alt="vendor-img"></td>
            <td class="title"><%# DataBinder.Eval(Container,"DataItem.firstname") %></td>
            ...
            <td class="action-icons">
              <div class="table-editable-icon">
                  ...
                  <div class="uiverse">
    <span  data-toggle="modal" data-target="#delete-model" >Delete</span>
 
</div>
</ContentTemplate>
 </asp:UpdatePanel>
                  <!-- Vertically centered modal -->
 <div class="modal fade delete-model" id="delete-model" role="dialog">
  ...
  color: #ffffff" data-dismiss="modal">No</button>
            <asp:Button ID="Button1" runat="server" class="btn btn-pink " Text="Yes"  Height="34px" style="width:auto ; border-radius:4px;" />
