...
public partial class Default2 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        SqlConnection con = new SqlConnection(strConnString);
            ...
            SqlCommand cd = new SqlCommand("update  vendor_signup set status='" + DropDownList1.SelectedItem + "'  where email='" + TextBox1.Text + "' ", con);
            SqlCommand cmd1 = new SqlCommand("update  login set status='" + DropDownList1.SelectedItem + "'  where email='" + TextBox1.Text + "' ", con);
            con.Open();
            cd.ExecuteNonQuery();
            ...
            Response.Redirect("admin_veryfy_Vendor.aspx");
            con.Close();
